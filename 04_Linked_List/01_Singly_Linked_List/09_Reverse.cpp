...
Node* reverseWithoutReference(Node* head,Node* tail){
    ...
    Node* slave_er_dewa_reverse = reverseWithoutReference((*head).next,tail);
    //---
    //---this work high time complextiy---//
    // Node* tmp = head;
    // while((*tmp).next!=NULL){
    //     tmp = (*tmp).next;
    // }
...
Node* reverseWithReference(Node* &head,Node* &tail){
...
int main(){
    ...
    printList(head);
    cout<<"\n";
    Node* x = reverseWithoutReference(head,tail);
    printList(tail);
    cout<<"\n";
    Node* y = reverseWithoutReference(tail,head);
    printList(y);
    cout<<"\n";
    Node* z = reverseWithReference(head,tail);
    printList(head);
    cout<<"\n";
